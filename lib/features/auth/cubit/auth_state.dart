...
class AuthState with _$AuthState {
  ...
  const factory AuthState.loginError(ApiErrorModel failure) = AuthStateLoginError;
  const factory AuthState.timeOut({Future<void> Function()? function}) = TimeoutFailureAuth;
