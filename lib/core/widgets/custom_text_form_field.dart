    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: OutlineInputBorder(
          borderRadius: borderRadius ?? BorderRadius.circular(10.r),
          borderSide: BorderSide(color: Colors.red, width: borderWidth ?? 1.sp),
        ),
        ...
        //     BoxConstraints(minWidth: 20.sp, minHeight: 20.sp),
        // prefix: prefixIcon,
        enabled: enabled ?? true,
        contentPadding:
            contentPadding ??
            EdgeInsets.symmetric(horizontal: 15.w, vertical: height ?? 15.h),
        fillColor: backgroundColor ?? AppColors.textFormFieldColor,
      ),
